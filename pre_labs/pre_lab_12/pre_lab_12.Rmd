...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer** The date column is listed as a character.
...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; what other information about these releases might you want to add? **Answer** I would add the links and the text itself because you can use it to run text analysis.
...
**Task** Run the following code in the gray-colored codeblock below to find the <li> tags. What does the output suggest about how many <ul> tags there are in the HTML source? **Answer** That there are a lot of ul tags that have different kinds of lists in them.
...
tags. Describe the output: **Answer** It shows all the texts of every list item, including the ones we don't need like social media.
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer** You get a list of all the text in a single column. We still have the ones we don't need.
