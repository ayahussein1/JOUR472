...
https://www.datawrapper.de/_/76wYa/ 
...
md_gov_county <- md_gov_county |> clean_names() |> 
...
- We used the already existing counties map for Maryland to that feature didn't make a difference.
...
- The new popups are much easier on the eye now, because the decimal places have been greatly reduced and the percentage sign was added to the end. Also, it's much easier to identify the counties by name and not fips code.
...
https://www.datawrapper.de/_/O7fq9/
